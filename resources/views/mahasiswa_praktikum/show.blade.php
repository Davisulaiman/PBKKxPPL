...
<div class="container-fluid px-4">
    ...
    <div class="action-container">
        <div class="import-section">
            ...
            <form action="{{ route('import.mahasiswa', $mataKuliah->id) }}" method="POST" enctype="multipart/form-data" class="import-form">
                @csrf
            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @forelse ($mahasiswas as $index => $mahasiswa)
                            <tr>
                                ...
                                <td class="text-center">
                                    <a href="{{ route('mahasiswa_praktikum.edit', $mahasiswa->id) }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <button type="button" class="btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#deleteModal{{ $mahasiswa->id }}">
                                        <i class="fas fa-trash-alt"></i> Hapus
                                    </button>
                                    <a href="{{ route('attendance.index', $mahasiswa->pivot->id) }}" class="btn btn-info btn-sm">
                                        ...
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    Apakah kamu yakin ingin menghapus data mahasiswa <strong>{{ $mahasiswa->nama }}</strong>?
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                                    <form action="{{ route('mahasiswa_praktikum.destroy', $mahasiswa->id) }}" method="POST" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="4" class="text-center">Tidak ada mahasiswa terdaftar untuk mata kuliah ini.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
    ...
    <div class="modal fade" id="deleteAllModal" tabindex="-1" aria-labelledby="deleteAllModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Apakah kamu yakin ingin menghapus semua data mahasiswa pada mata kuliah <strong>{{ $mataKuliah->nama_mata_kuliah }}</strong>?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
