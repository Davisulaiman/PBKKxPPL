            ...
            <div class="col-md-8">
                <div class="card shadow-sm">
                    <div class="card-header bg-primary text-white">
                        <h4 class="mb-0">Edit Penilaian Praktikum</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <!-- Form for Editing Penilaian Praktikum -->
                        <form action="{{ route('penilaian_praktikum.update', $penilaianPraktikum->id) }}" method="POST">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="mb-3">
                                ...
                                <select name="mata_kuliah_praktikum_id" id="mata_kuliah_praktikum" class="form-select @error('mata_kuliah_praktikum_id') is-invalid @enderror" required>
                                    @foreach($mataKuliahPraktikum as $mataKuliah)
                                        <option value="{{ $mataKuliah->id }}" {{ $penilaianPraktikum->mata_kuliah_praktikum_id == $mataKuliah->id ? 'selected' : '' }}>
